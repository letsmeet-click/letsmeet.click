...
docker run --name letsmeet-nginx --net="host" -v `pwd`/../data:/home/uid1000/letsmeet -v `pwd`/nginx.conf:/etc/nginx/nginx.conf -v /etc/letsencrypt/live/www.letsmeet.click/:/home/uid1000/letsmeet/nginx/ --restart=always -d nginx
